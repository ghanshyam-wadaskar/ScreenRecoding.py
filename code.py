...
#background image
image1=PhotoImage(file=r"yelllow.png")
Label(root,image=image1,bg="#fff").place(x=-2,y=35)

image2=PhotoImage(file=r"blue.png")
...
image3=PhotoImage(file=r"recording.png")
